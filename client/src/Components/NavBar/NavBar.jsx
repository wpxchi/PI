...
import { orderName, orderOrigin, orderAttack, orderTypes } from "../../Redux/actions";
  ...
  const TypeHandler=(event)=>{ dispatch(orderTypes(event.target.value))};
    return (
      ...
      <div className={style.NavBar}>
          <select onChange={NameHandler} className={style.Alphabetical}>
           <option value='All'>ALL</option>
           <option value='Az'>A-Z</option>
           <option value='Za'>Z-A</option>
          </select>

          <select onChange={AttackHandler} className={style.Attack}>
          <option value='All'>ATTACK</option>
          <option value='Max'>MAX</option>
          <option value='Min'>MIN</option>
          </select>

          <select onChange={OriginHandler} className={style.Origin}>
            <option value='All'>ORIGIN</option>
            <option value='Api'>API</option>
            <option value='Created'>CREATED</option>
          </select>
          
          <select onChange={TypeHandler} className={style.Types}>
